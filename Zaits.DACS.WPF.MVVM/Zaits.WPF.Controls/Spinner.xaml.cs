...
namespace Controls
{
    public partial class Spinner : UserControl
    {
        ...
        public static readonly DependencyProperty CircleRotationProperty = DependencyProperty.Register(nameof(CircleRotation), typeof(Rotation), typeof(Spinner), new PropertyMetadata(Rotation.Clockwise));
